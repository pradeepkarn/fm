...
<section>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="d-flex">
                    ...
                    <input type="hidden" name="user_group" value="<?php echo $ug; ?>">
                </div>
                </form>
                </div>
            <div class="col-md-12">
                <div class="pagination">
                    ...
                    if ($enqs->filter_index(['user_group'=>$ug],$ord='',$limit = 999999,$change_order_by_col="id")!=false) {
                        $nubenqs = count($enqs->filter_index(['user_group'=>$ug],$ord='',$limit = 999999,$change_order_by_col="id")); ?>
                        <?php $i=0; $page = 1; while($i < $nubenqs){ ?>
                            <a class="<?php if(isset($_GET['startfrom_numrows'])){ echo($_GET['startfrom_numrows']==$i.',5')?"active":""; } ?>" href="/<?php echo home; ?>/admin/all-users/?user_group=<?php echo $ug; ?>&startfrom_numrows=<?php echo $i; ?>,5"><?php echo $page; ?></a>
                        <?php  $i+=5; $page++; } ?>
                    <?php  }
                    ?>
        ...
        //     $uObj = new Model('pk_user');
        //     $alluser = $uObj->index();
            
        //     // myprint($alluser);
    
        //    function pyramid($row=4,$line_break_type="<br>")
        //    {
        //     $row = 4;
        //         for($i=1;$i<=$row;$i++)
        //         {
        ...
        //                 echo $j;
        //             }
        //             echo $line_break_type;
        //         }
        //    }
        //    pyramid($row=4,$line_break_type="<br>");
        //     return;
            ...
            if (isset($_GET['startfrom_numrows'])) {
               ...
               $arrug['user_group']=$ug;
            $users = $usrObj->filter_index($arrug,$ord='DESC',$limit,"id");
            ...
            if (isset($_GET['user_serch_keywords'])) {
                ...
                $users = $usrObj->search($srcharr, $ord='DESC',$limit =10,$change_order_by_col="id",array('user_group'=>$ug));
            } 
            ...
            //     $db->tableName = "pk_user";
                ...
                <tr>
                    ...
                    <td><a class="text-deco-none" href="/<?php echo home; ?>/admin/edit-account/?edit_user_id=<?php echo $pv['id']; ?>&user_group=<?php echo $ug; ?>"><i class="fas fa-edit"></i></a> <?php echo $pv['id']; ?></td> 
