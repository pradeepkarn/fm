                ...
                <div class="col-md-4">
                    <div class="d-grid">
                        ...
                        <div class="my-4 d-flex justify-content-end">
                            <a class="btn btn-primary" href="/<?php echo home; ?>/admin/services/add-new-item/?vendor_id=<?php echo isset($_GET['vendor_id']) ? $_GET['vendor_id'] : 1; ?>&salon_id=<?php echo isset($_GET['salon_id']) ? $_GET['salon_id'] : 0; ?>"> <i class="fas fa-plus"></i> Add New Service</a>
                        </div>
                        <table id="datatablesSimple" class="table-sm table table-bordered">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['vendor_id']) && intval($_GET['vendor_id'])) {
                                    $pgqry['created_by'] = $_GET['vendor_id'];
                                }
                                if (isset($_GET['salon_id']) && intval($_GET['salon_id'])) {
                                    $pgqry['company_id'] = $_GET['salon_id'];
                                }
                                $pgqry['content_group'] = "service";
                                ...
                                if ($prods != false) {
                                    foreach ($prods as $pk => $pv) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo (getData("service_category", $pv['service_cat_id']) != false) ? getData("service_category", $pv['service_cat_id'])['name'] : "NA"; ?></td>
                                            <td><span class="<?php echo ($pv['post_category'] == "featured") ? "p-1 bg-primary text-white" : "";
                                                                echo ($pv['post_category'] == "trending") ? "p-1 bg-success text-white" : ""; ?>"><?php echo $pv['post_category']; ?></span></td>
                                            <td><a target="_blank" href='<?php echo "/" . home . "/item/?lid={$pv['id']}"; ?>'>View</a></td>
                                            <td><a href="/<?php echo home; ?>/admin/services/edit/<?php echo $pv['id']; ?>">Edit</a></td>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a class="btn btn-danger" href="/<?php echo home; ?>/admin/services/delete/<?php echo $pv['id']; ?>">Delete</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
