                            ...
                            <div class="col-md-8">
                                <div class="row ">
                                    <div class="col-md-6">
                                        <h5>Category</h5>
                                        <?php
                                        $catData = (new Model('service_category'))->index(); ?>
                                        <select required class="update_page form-select" name="service_cat_id" id="cats">
                                            <?php
                                            foreach ($catData as $sct) {
                                                $cn = obj($sct);
                                            ?>
                                        ...
                                        <script>
                                            ...
                                            $('#cats option').each(function() {
                                                if (this.value == '<?php echo $page['service_cat_id']; ?>') {
                                                    // exists = true;
                                                    // return false;
                                                    $("#cats").val("<?php echo $page['service_cat_id']; ?>");
                                                }
                                            });
                                        </script>
                                    </div>
...
<!-- 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <h5>Duration</h5>
                                        <input type="text" name="duration" value="<?php echo $page['duration']; ?>" class="form-control mb-2 update_page">
                                    </div>
                                    <div class="col">
                                        <h5>Duration Unit</h5>
                                        <select name="duration_unit" class="form-control my-1 update_page">
                                            <option <?php echo $page['duration_unit']=="min"?'selected':null; ?> value="min">Minute</option>
                                            <option <?php echo $page['duration_unit']=="hr"?'selected':null; ?> value="hr">Hour</option>
                                        </select>
                                    </div>
                                    <div class="col">
                                        <h5>Disc. Amt</h5>
                                        <input type="text" name="discount_amt" value="<?php echo $page['discount_amt']; ?>" class="form-control mb-2 update_page">
                                    </div>
                                    <div class="col">
                                        <h5>Sale Price</h5>
                                        <b>= <?php echo $page['price'] - $page['discount_amt']; ?></b>
                    ...
                    <textarea name="page_other_content" class="tiny_textarea form-control mb-2 update_page" rows="10"><?php //echo $page['other_content']; 
                                ...
                                <!-- Attribute  Details -->
                                <div style="max-height: 250px; overflow-y: scroll; display:none;">
                                    ...
                                    ?>
                                        ...
                                        <div class="row container my-2">
                                            <div class="col" style="background-color: lightgrey;">
                                                <table class="table table-bordered border-secondary">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <p class="title"><?php echo $fvl['heading']; ?></p>
                                                        </td>
                                                        <td>
                                        ...
                                        <?php pkAjax("#delete-this-detail{$fvl['id']}", "/admin/services/delete-content-details", ".delete-data-detail{$fvl['id']}", "#res-delt"); ?>
                                    <?php endforeach;  ?>

                                </div>
                                <form class="hide" action="/<?php echo home; ?>/admin/services/add-more-detail" id="add-more-detail-form">
                                    <!-- <div class="progress">
                            ...
                            <div class="col-md-4">
                                ...
                                <a class="btn btn-dark mb-4" href="/<?php echo home; ?>/admin/<?php echo $plugin_dir; ?>/services-by-salon/?vendor_id=<?php echo $page['created_by']; ?>&salon_id=<?php echo $page['company_id']; ?>">Back</a>
                    ...
                    <button class="btn btn-primary mb-1" data-bs-target="#GalleryModel" data-bs-toggle="modal">Select From Gallery</button>
                                ...
                                <div style="max-height: 100px; overflow-y: scroll;">
                                    <ul class="list-none">
                                        ...
                                        foreach ($imgs as $key => $fvl) : ?>
                                            ...
                                            <?php pkAjax("#delete-this-img{$fvl['id']}", "/admin/services/delete-content-details", ".delete-data{$fvl['id']}", "#res-delt"); ?>
                                        <?php endforeach;  ?>
                                    </ul>
                                </div>
                                <form action="/<?php echo home; ?>/admin/services/add-more-img" id="add-more-img-form">
                                    <div class="progress">
                                        <div class="progress-bar"></div>
                                    </div>
                                    <input type="hidden" name="content_id" value="<?php echo $page['id']; ?>">
                                ...
                                <select id="post_cat_select" name="post_category" class="form-control update_page">
                                    ...
                                    $cts = $dbcat->filterDistinctWhr($col = "post_category", ['content_group' => 'service'], $ord = '', $limit = 100);
                ...
                <script>
                    $(document).ready(function() {
                        $('#update_page_btn').click(function(event) {
                            ...
                            tinyMCE.triggerSave();
                            $.ajax({
                                url: "/<?php echo home; ?>/admin/services/edit/<?php echo $page['id']; ?>/update",
                                method: "post",
