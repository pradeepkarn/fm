                    ...
                    <div class="col-md-12">
                        <form id="add-new-product-btn-form" action="/<?php echo home; ?>/admin/<?php echo $plugin_dir; ?>/add-new-item-ajax" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" onkeyup="createSlug('page_title', 'page_slug');" id="page_title" required name="page_title" placeholder="Service Name" class="form-control mb-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <h5>Duration</h5>
                                            <input type="text" name="duration" class="form-control mb-2 update_page">
                                        </div>
                                        <div class="col">
                                            <h5>Duration Unit</h5>
                        ...
                        <input type="text" name="qty" class="form-control mb-2 update_page">
                                    ...
                                    <div class="d-grid mb-5">
                                        <input type="hidden" name="created_by" value="<?php echo isset($_GET['vendor_id'])?$_GET['vendor_id']:$_SESSION['user_id']; ?>">
                                        <input type="hidden" name="company_id" value="<?php echo isset($_GET['salon_id']) ? $_GET['salon_id'] : 0; ?>">
                                ...
                                <div class="col-md-4">
                                    <a class="btn btn-dark mb-4" href="/<?php echo home; ?>/admin/<?php echo $plugin_dir; ?>/services-by-salon/?vendor_id=<?php echo isset($_GET['vendor_id'])?$_GET['vendor_id']:$_SESSION['user_id']; ?>&salon_id=<?php echo isset($_GET['salon_id']) ? $_GET['salon_id'] : 0; ?>">Back</a>
