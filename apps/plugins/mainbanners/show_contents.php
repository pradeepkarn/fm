    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="my-4 d-flex justify-content-end">
                    <a class="btn btn-primary" href="/<?php echo home; ?>/admin/<?php echo $plugin_dir; ?>/add-new-item"> <i class="fas fa-plus"></i> Add New mainbanners</a>
            </div>
            ...
            <?php 
                ...
                $pgqry['content_group'] = "mainbanner";
                // $pgqry['content_type'] = "slider";
                ...
                <tr>
                    ...
                    <td><?php echo $pv['content_type']; ?></td> 
                    ...
                    <td><a href="/<?php echo home; ?>/admin/mainbanners/edit/<?php echo $pv['id']; ?>">Edit</a></td>
                    ...
                    <div class="modal-dialog">
                        ...
                        <a class="btn btn-danger" href="/<?php echo home; ?>/admin/mainbanners/delete/<?php echo $pv['id']; ?>">Delete</a>
                        </div>
                        </div>
                    </div>
                    </div>
