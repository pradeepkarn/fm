...
// else if($url[0]=='save-bookmark-by-ajax'){
//     // print_r($_POST);
//     if (authenticate()===false) {
//       return;
//     }
//     $bookmark = new Model('bookmarks');
//     $arr['book_id'] = $_POST['book_id'];
//     $arr['user_id'] = $_SESSION['user_id'];
//     $arr['content_group'] = 'bookmark';

//     $already = $bookmark->filter_index($arr);

//     if ($already==false) {
//       $arr['page_id'] = $_POST['page_id'];
//       $arr['detail'] = $_POST['chapter'];
//       $bookmark->store($arr);
...
//     }
//   }
//   else if($url[0]=='save-favorite-chapter-by-ajax'){
//     // print_r($_POST);
//     if (authenticate()===false) {
//       return;
//     }
...
//     $arr['page_id'] = $_POST['page_id'];
//     $arr['user_id'] = $_SESSION['user_id'];
//     $arr['content_group'] = 'favorite_chapter';
